...
public class EnemyMarch : MonoBehaviour
{
    ...
    public static EnemyMarch instance;
    ...
    void Start()
    {
        ...
        marchAttack = attackBox.GetComponent<MarchAttack>();
    ...
    void follow()
    {
        ...
        if (distanceStop >= 1.3)
        {
            ...
            if (marchAttack.isStunned == true && enemyHealth.isDead == false)
            {
                rb.velocity = new Vector2(0, 0);
                StunDirection();
            }
            else if (marchAttack.hasAttacked == false && enemyHealth.isDead == false)
            {
    ...
    {
        if (rb.velocity.y == -speed && marchAttack.hasAttacked == false)
        {
            //gå ner
        ...
        if (rb.velocity.x == -speed && marchAttack.hasAttacked == false)
        {
            //gå vänster
